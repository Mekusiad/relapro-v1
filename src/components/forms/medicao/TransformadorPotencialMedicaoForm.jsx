// src/components/forms/medicao/TransformadorPotencialMedicaoForm.jsx
...
function TransformadorPotencialMedicaoForm({ data, onDataChange }) {
    const formData = data || {};
...
export default TransformadorPotencialMedicaoForm;
