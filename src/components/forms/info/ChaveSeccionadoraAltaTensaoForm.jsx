// src/components/forms/info/ChaveSeccionadoraAltaTensaoForm.jsx

import React from "react";

function ChaveSeccionadoraAltaTensaoForm({ data, onChange }) {
  return (
...
export default ChaveSeccionadoraAltaTensaoForm;
