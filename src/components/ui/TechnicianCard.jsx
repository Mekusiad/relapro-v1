    ...
    <div className="technician-card">
      <div className="technician-card-header">
        <span className="technician-avatar">
          {getFirstLetter(technician.nome)}
        </span>
      ...
      <div className="technician-card-body">
        <p>
          <strong>Usuário:</strong> {technician.usuario}
        </p>
        <p>
          <strong>Matrícula:</strong> {technician.matricula || "N/A"}
        </p>
        <p>
          <strong>Nível:</strong>
          <span
            className={`access-level-badge level-${
              technician.nivelAcesso || "tecnico"
            }`}
          >
            {technician.nivelAcesso || "Técnico"}
          </span>
        </p>
      </div>
