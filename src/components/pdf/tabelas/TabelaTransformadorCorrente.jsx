// src/components/pdf/tabelas/TabelaTransformadorCorrente.jsx
...
const TabelaTransformadorCorrente = ({ componente, Html, stylesheet }) => {
  const relacaoColumns = [
    { key: "numSerie", label: "Nº Série" },
    { key: "correnteAT", label: "Corrente AT (A)" },
    { key: "correnteBT", label: "Corrente BT (A)" },
    { key: "terminais", label: "Terminais" },
    { key: "relacaoCalc", label: "Relação Calc." },
    { key: "relacaoMed", label: "Relação Med." },
    { key: "resistenciaOhmica", label: "Resist. Ôhmica (mΩ)" },
  ];
...
export default TabelaTransformadorCorrente;
