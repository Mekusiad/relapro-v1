// src/components/pdf/tabelas/TabelaChaveSeccionadora.jsx
...
const ServicosSection = ({ data }) => {
  ...
  const serviceLabels = {
    ...
    alinhamentoContatos: "Alinhamento dos Contatos",
    testesAcionamento: "Testes de Acionamento",
    lubrificacaoReaperto: "Lubrificação e Reaperto",
  };
...
const TabelaChaveSeccionadora = ({ componente, Html, stylesheet }) => {
  const contatoColumns = [
    { key: "polo", label: "Pólo" },
    { key: "condicao", label: "Condição" },
    { key: "corrente", label: "Corrente (A)" },
    { key: "valorMedido", label: "Valor Medido (µΩ)" },
    { key: "valorReferencia", label: "Valor Ref. (µΩ)" },
    { key: "tempo", label: "Tempo (s)" },
  ];
  const isolamentoColumns = [
    { key: "polo", label: "Pólo" },
    { key: "condicao", label: "Condição" },
    { key: "tensaoEnsaio", label: "Tensão (kV)" },
...
export default TabelaChaveSeccionadora;
