...
function Sidebar({ isSidebarOpen, toggleSidebar }) { 
  ...
  const sidebarClasses = `sidebar ${isSidebarOpen ? 'sidebar-mobile-open' : ''}`;
  ...
  return (
    <aside className={sidebarClasses}>
      <div className="sidebar-main-content">
        <NavLink to="/dashboard" className="logo-container-split" onClick={handleLinkClick}>
          <motion.div
        ...
        <nav className="nav-links">
          ...
          <NavLink to="/clients" className="nav-button" onClick={handleLinkClick}>
            <Building2 size={20} /> <span className="nav-text">Clientes</span>
          </NavLink>
          <NavLink to="/equipments" className="nav-button" onClick={handleLinkClick}>
            <Wrench size={20} /> <span className="nav-text">Equipamentos</span>
          </NavLink>
          <NavLink to="/faturamento" className="nav-button" onClick={handleLinkClick}>
            <Receipt size={20} /> <span className="nav-text">Faturamento</span>
          </NavLink>
          <NavLink to="/servicos-os" className="nav-button" onClick={handleLinkClick}>
            <ClipboardList size={20} /> <span className="nav-text">Serviços OS</span>
          </NavLink>
          <NavLink to="/technicians" className="nav-button" onClick={handleLinkClick}>
            <Users size={20} /> <span className="nav-text">Técnicos</span>
          </NavLink>
          <NavLink to="/visitas-tecnicas" className="nav-button" onClick={handleLinkClick}>
            <MapPin size={20} /> <span className="nav-text">Visitas Técnicas</span>
          </NavLink>
        </nav>
      </div>
